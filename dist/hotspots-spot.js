"use strict";
(self["webpackChunk_adobe_helix_project_boilerplate"] = self["webpackChunk_adobe_helix_project_boilerplate"] || []).push([["hotspots-spot"],{

/***/ "./blocks/hotspots-spot/hotspots-spot.js":
/*!***********************************************!*\
  !*** ./blocks/hotspots-spot/hotspots-spot.js ***!
  \***********************************************/
...
/* harmony export */ });
/* harmony import */ var _hotspots_hotspots_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../hotspots/hotspots.js */ "./blocks/hotspots/hotspots.js");
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([_hotspots_hotspots_js__WEBPACK_IMPORTED_MODULE_0__]);
_hotspots_hotspots_js__WEBPACK_IMPORTED_MODULE_0__ = (__webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__)[0];
...
function decorate(block) {
  ...
  (0,_hotspots_hotspots_js__WEBPACK_IMPORTED_MODULE_0__.addSpot)(hotspotsBlock, hotspot);
...
function decorateImageAndTitle(mainDiv, firstPicture, title, description) {
  const hotspot = (0,_scripts_common_js__WEBPACK_IMPORTED_MODULE_0__.createElement)('div', { classes: ['hotspot', 'animated'] });
  hotspot.innerHTML = `
...
function addMobileTabNavigation(block, title, hotspotAreaId) {
  ...
  if (!mobileNav) {
    mobileNav = (0,_scripts_common_js__WEBPACK_IMPORTED_MODULE_0__.createElement)('div', {
      props: { id: 'hotspots-mobile-nav' },
    });

    const ul = (0,_scripts_common_js__WEBPACK_IMPORTED_MODULE_0__.createElement)('ul', { classes: 'featurenav-list' });
    mobileNav.append(ul);

    document.querySelector('main').append(mobileNav);
  }

  const li = (0,_scripts_common_js__WEBPACK_IMPORTED_MODULE_0__.createElement)('li', { classes: 'featurenav-list-item' });
  li.dataset.hotspotTargetId = hotspotAreaId;
  if (mobileNav.firstElementChild.childElementCount === 0) {
    li.classList.add('active');
  }

  const link = (0,_scripts_common_js__WEBPACK_IMPORTED_MODULE_0__.createElement)('a', { props: { href: `#${title.textContent}` } });
...
/******/ var __webpack_exports__ = (__webpack_exec__("./blocks/hotspots-spot/hotspots-spot.js"));
/******/ }
]);