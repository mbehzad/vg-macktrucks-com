"use strict";
(self["webpackChunk_adobe_helix_project_boilerplate"] = self["webpackChunk_adobe_helix_project_boilerplate"] || []).push([["eloqua-form"],{

/***/ "./blocks/eloqua-form/eloqua-form.js":
/*!*******************************************!*\
  !*** ./blocks/eloqua-form/eloqua-form.js ***!
  \*******************************************/
...
/* harmony export */   addNoCookieMessage: () => (/* binding */ addNoCookieMessage),
...
const loadFormScripts = async (elqForm) => {
  ...
  for (const script of [...elqForm.querySelectorAll('script')]) {
    ...
    if (script.getAttribute('src')) {
      waitForLoad = (0,_scripts_scripts_js__WEBPACK_IMPORTED_MODULE_0__.loadScriptIfNotLoadedYet)(script.getAttribute('src'), scriptAttrs);
    } else {
      ...
      const newScript = (0,_scripts_common_js__WEBPACK_IMPORTED_MODULE_1__.createElement)('script', { props: { type: 'text/javascript' } });
...
const addForm = async (block) => {
  ...
  const formWrapper = (0,_scripts_common_js__WEBPACK_IMPORTED_MODULE_1__.createElement)('div', { classes: 'eloqua-form-container' });
...
const addNoCookieMessage = (messageContainer) => {
  const messageText = (0,_scripts_common_js__WEBPACK_IMPORTED_MODULE_1__.getTextLabel)('no form message');
  const messageLinkText = (0,_scripts_common_js__WEBPACK_IMPORTED_MODULE_1__.getTextLabel)('no form link message');

  const messageEl = (0,_scripts_common_js__WEBPACK_IMPORTED_MODULE_1__.createElement)('div', ['eloqua-form-no-cookie']);
  messageEl.innerHTML = `
...
async function decorate(block) {
  const observer = new IntersectionObserver((entries) => {
    if (entries.some((e) => e.isIntersecting)) {
      if (!(0,_scripts_common_js__WEBPACK_IMPORTED_MODULE_1__.isTargetingAllowed)()) {
...
/******/ var __webpack_exports__ = (__webpack_exec__("./blocks/eloqua-form/eloqua-form.js"));
/******/ }
]);