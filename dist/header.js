"use strict";
(self["webpackChunk_adobe_helix_project_boilerplate"] = self["webpackChunk_adobe_helix_project_boilerplate"] || []).push([["header"],{
...
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([_scripts_common_js__WEBPACK_IMPORTED_MODULE_0__, _scripts_scripts_js__WEBPACK_IMPORTED_MODULE_2__]);
([_scripts_common_js__WEBPACK_IMPORTED_MODULE_0__, _scripts_scripts_js__WEBPACK_IMPORTED_MODULE_2__] = __webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__);




// check if the header has to have a login and/or a search button
const { SEARCH_DISABLED, LOGIN_DISABLED } = _scripts_common_js__WEBPACK_IMPORTED_MODULE_0__.HEADER_CONFIGS;
...
const createLogo = (logoWrapper) => {
  ...
  if (logoLink) {
    const logoLinkTextContainer = (0,_scripts_common_js__WEBPACK_IMPORTED_MODULE_0__.createElement)('span', { classes: ['screenreader'] });
    const logoLinkText = (0,_scripts_common_js__WEBPACK_IMPORTED_MODULE_0__.getTextLabel)('Logo link');
...
const createMainLinks = (mainLinksWrapper) => {
  ...
  if (list) {
    ...
    list.querySelectorAll('li').forEach((listItem) => {
      ...
      mainNavLink.setAttribute('id', (0,_scripts_common_js__WEBPACK_IMPORTED_MODULE_0__.generateId)('main-nav'));
    });
    ...
    const closeMenuLabel = (0,_scripts_common_js__WEBPACK_IMPORTED_MODULE_0__.getTextLabel)('Close menu');
...
const mobileActions = () => {
  ...
  const searchLabel = (0,_scripts_common_js__WEBPACK_IMPORTED_MODULE_0__.getTextLabel)('Search');
  const openMenuLabel = (0,_scripts_common_js__WEBPACK_IMPORTED_MODULE_0__.getTextLabel)('Open menu');
  ...
  data.forEach((menuData) => {
    ...
    menusContentList.forEach((menuItem) => {
      ...
      if (menuItem.classList.contains(tabsVariants.TAB_WITH_CARDS)) {
        ...
        const listEl = (0,_scripts_common_js__WEBPACK_IMPORTED_MODULE_0__.createElement)('ul');

        item.forEach((mItem) => {
          const listItemEl = (0,_scripts_common_js__WEBPACK_IMPORTED_MODULE_0__.createElement)('li');
...
async function decorate(block) {
  ...
  const isMobileMenuDisabled = (0,_scripts_aem_js__WEBPACK_IMPORTED_MODULE_1__.getMetadata)('custom-header-mobile-menu').toLowerCase() === 'false';
  if (isCustomHeader) {
    navPath = `${langCodeMatch ? langCodeMatch[1] : ''}${isCustomHeader}`;
    block.classList.add(`${blockClass}__custom`);

    const customStyles = (0,_scripts_aem_js__WEBPACK_IMPORTED_MODULE_1__.getMetadata)('custom-header-style');
    if (customStyles) {
      block.classList.add(`${blockClass}__custom--${customStyles}`);
    }
  }

  const testHeader = (0,_scripts_aem_js__WEBPACK_IMPORTED_MODULE_1__.getMetadata)('test-header');
  ...
  const swapActionsLinks = (isDesktop) => {
    ...
    const buttonsWithoutIcons = (0,_scripts_scripts_js__WEBPACK_IMPORTED_MODULE_2__.getAllElWithChildren)([...actionsLinks.querySelectorAll('a')], '.icon', true);
...
/******/ var __webpack_exports__ = (__webpack_exec__("./blocks/header/header.js"));
/******/ }
]);