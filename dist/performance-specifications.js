"use strict";
(self["webpackChunk_adobe_helix_project_boilerplate"] = self["webpackChunk_adobe_helix_project_boilerplate"] || []).push([["performance-specifications"],{

/***/ "./blocks/performance-specifications/performance-specifications.js":
/*!*************************************************************************!*\
  !*** ./blocks/performance-specifications/performance-specifications.js ***!
  \*************************************************************************/
...
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([_scripts_scripts_js__WEBPACK_IMPORTED_MODULE_0__, _scripts_common_js__WEBPACK_IMPORTED_MODULE_2__]);
([_scripts_scripts_js__WEBPACK_IMPORTED_MODULE_0__, _scripts_common_js__WEBPACK_IMPORTED_MODULE_2__] = __webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__);
...
const updateChart = async (chartContainer, performanceData) => {
  if (!window.echarts) {
    ...
    await (0,_scripts_aem_js__WEBPACK_IMPORTED_MODULE_1__.loadScript)('/common/echarts-5.4.2/echarts.custom.only-linecharts.min.js');
  }
...
const renderEngineSpecs = (engineDetails) => {
  ...
  return (0,_scripts_scripts_js__WEBPACK_IMPORTED_MODULE_0__.div)({ class: 'key-specs' },
    (0,_scripts_scripts_js__WEBPACK_IMPORTED_MODULE_0__.domEl)('dl', {}, ...engineDetails.facts.map((cells) => [
      (0,_scripts_scripts_js__WEBPACK_IMPORTED_MODULE_0__.domEl)('dt', cells[0]),
      (0,_scripts_scripts_js__WEBPACK_IMPORTED_MODULE_0__.domEl)('dd', cells[1]),
    ])
      .flat()),
    (0,_scripts_scripts_js__WEBPACK_IMPORTED_MODULE_0__.p)({ class: 'button-container' },
      (0,_scripts_scripts_js__WEBPACK_IMPORTED_MODULE_0__.a)({
        class: 'button button--primary download-specs',
        href: downloadSpecs ? specsLink.toString() : '#',
        target: '_blank',
      }, (0,_scripts_common_js__WEBPACK_IMPORTED_MODULE_2__.getTextLabel)('Download Specs'))),
  );
};
...
const renderCategoryDetail = (block, categoryData, selectEngineId = null) => {
  const categoryDetails = (0,_scripts_scripts_js__WEBPACK_IMPORTED_MODULE_0__.div)({ class: 'category-detail' });
  ...
  Object.keys(categoryData.engines).forEach((engineId, index) => {
    ...
    const engineButton = (0,_scripts_scripts_js__WEBPACK_IMPORTED_MODULE_0__.button)({ role: 'tab', 'aria-selected': isSelected }, engineId);
...
const renderCategoryTabList = ({ block, categoryData, activeCategory }) => {
  const tabListWrapper = (0,_scripts_scripts_js__WEBPACK_IMPORTED_MODULE_0__.div)({ class: 'category-tablist-wrapper' });
  const tabList = (0,_scripts_scripts_js__WEBPACK_IMPORTED_MODULE_0__.ul)({ role: 'tablist', class: 'category-tablist' });
  const activeLine = (0,_scripts_scripts_js__WEBPACK_IMPORTED_MODULE_0__.li)({ class: 'active-line' });
  ...
  Object.keys(categoryData).forEach((categoryId) => {
    ...
    const tabItem = (0,_scripts_scripts_js__WEBPACK_IMPORTED_MODULE_0__.li)({ class: `category-tab${isActive ? ' active' : ''}` });
    const tabButton = (0,_scripts_scripts_js__WEBPACK_IMPORTED_MODULE_0__.button)({
      class: 'tab',
      role: 'tab',
...
async function decorate(block) {
  ...
  const detailPanel = (0,_scripts_scripts_js__WEBPACK_IMPORTED_MODULE_0__.div)({ class: 'details-panel' },
    renderEngineSpecs(engineDetails),
    (0,_scripts_scripts_js__WEBPACK_IMPORTED_MODULE_0__.div)({ class: 'performance-chart' },
      (0,_scripts_scripts_js__WEBPACK_IMPORTED_MODULE_0__.div)({ class: 'loading-spinner' }),
    ));
...
/******/ var __webpack_exports__ = (__webpack_exec__("./blocks/performance-specifications/performance-specifications.js"));
/******/ }
]);