"use strict";
(self["webpackChunk_adobe_helix_project_boilerplate"] = self["webpackChunk_adobe_helix_project_boilerplate"] || []).push([["v2-inpage-navigation"],{

/***/ "./blocks/v2-inpage-navigation/v2-inpage-navigation.js":
/*!*************************************************************!*\
  !*** ./blocks/v2-inpage-navigation/v2-inpage-navigation.js ***!
  \*************************************************************/
...
const inpageNavigationButton = () => {
  ...
  if ((0,_scripts_aem_js__WEBPACK_IMPORTED_MODULE_0__.getMetadata)('inpage-button') && (0,_scripts_aem_js__WEBPACK_IMPORTED_MODULE_0__.getMetadata)('inpage-link')) {
    const titleMobile = (0,_scripts_aem_js__WEBPACK_IMPORTED_MODULE_0__.getMetadata)('inpage-button');
    const url = (0,_scripts_aem_js__WEBPACK_IMPORTED_MODULE_0__.getMetadata)('inpage-link');
    const link = (0,_scripts_common_js__WEBPACK_IMPORTED_MODULE_1__.createElement)('a', {
    ...
    const mobileText = (0,_scripts_common_js__WEBPACK_IMPORTED_MODULE_1__.createElement)('span', { classes: `${blockName}__cta--mobile` });
    mobileText.textContent = titleMobile;
    link.appendChild(mobileText);

    const titleDesktop = (0,_scripts_aem_js__WEBPACK_IMPORTED_MODULE_0__.getMetadata)('inpage-button-large');
    if (titleDesktop) {
      const desktopText = (0,_scripts_common_js__WEBPACK_IMPORTED_MODULE_1__.createElement)('span', { classes: `${blockName}__cta--desktop` });
...
async function decorate(block) {
  ...
  const dropdownArrowIcon = (0,_scripts_common_js__WEBPACK_IMPORTED_MODULE_1__.createElement)('span', { classes: [`${blockName}__icon`, 'icon', 'icon-dropdown-caret'] });
  ...
  window.addEventListener('scroll', (0,_scripts_common_js__WEBPACK_IMPORTED_MODULE_1__.debounce)(() => {
  ...
  (0,_scripts_common_js__WEBPACK_IMPORTED_MODULE_1__.decorateIcons)(block);
}
...
/******/ var __webpack_exports__ = (__webpack_exec__("./blocks/v2-inpage-navigation/v2-inpage-navigation.js"));
/******/ }
]);